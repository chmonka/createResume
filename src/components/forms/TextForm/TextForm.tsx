    ...
    return (
        <div className='text-form'>
            <div className='text-form__layout'>
                <label htmlFor="" className='text'>Расположение</label>
            ...
            <div className='text-form__content'>
                ...
                <textarea  className='text-form__textarea' value={value} onChange={onChange} placeholder='Введите текст'></textarea>
            </div>
        </div>
    )
}
